...
public class Cadastrar {
    ...
    public Cadastrar() {
        ...
        Show s1 = new Show(1, "20/05/2026", c1, a1);
		a1.addShow(s1); c1.addShow(s1);

		Show s2 = new Show(2, "21/05/2026", c1, a2);
		a2.addShow(s2); c1.addShow(s2);

		Show s3 = new Show(3, "10/06/2026", c2, a1);
		a1.addShow(s3); c2.addShow(s3);

		Show s4 = new Show(4, "12/06/2026", c2, a4);
		a4.addShow(s4); c2.addShow(s4);

		Show s5 = new Show(5, "05/07/2026", c3, a3);
		a3.addShow(s5); c3.addShow(s5);

		Show s6 = new Show(6, "06/07/2026", c3, a2);
		a2.addShow(s6); c3.addShow(s6);

		Show s7 = new Show(7, "15/08/2026", c4, a4);
		a4.addShow(s7); c4.addShow(s7);

		Show s8 = new Show(8, "16/08/2026", c4, a3);
